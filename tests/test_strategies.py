...
def test_sma_switch_targets_leverage_above_sma_else_cash() -> None:
    strat = SmaSwitch("t", leveraged="TQQQ", cash="SGOV", sma_window=3)
...
def test_drawdown_tilt_200w_guard_disables_leverage_below_trend() -> None:
    # Long downtrend: last price below the 200w (here short-window) SMA → guard forces base.
